    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans scroll-smooth">
      ...
      <header className="bg-white border-b sticky top-0 z-50 shadow-sm backdrop-blur-md bg-white/95">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          {/* Logo & Stylized Name Container (1.5x SIZE) */}
      ...
      {/* EXTREMELY VISIBLE FLOATING 24/7 CHAT SUPPORT BUTTON */}
      <button 
        aria-label="Open 24/7 Chat Support"
        className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 bg-gradient-to-r from-[#166534] to-[#14532d] text-white px-6 py-4 rounded-full shadow-[0_10px_25px_rgba(22,101,52,0.4)] text-lg font-bold hover:scale-105 active:scale-95 transition-all z-50 flex items-center gap-3 animate-bounce cursor-pointer border-2 border-white"
      >
        <span className="text-2xl drop-shadow-md">💬</span>
        <span className="tracking-wide">24/7 Chat Support</span>
      </button>
